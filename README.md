...
1. Open and log into Cloud9. If you do not have an account make sure to create one.  
2. Open and log into Github. If you do not have an account make sure to create one.  
